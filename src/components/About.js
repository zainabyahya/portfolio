        ...
        <Animated>
            <div className='py-10 px-[10vw] flex flex-col items-center justify-center lg:h-[80vh] lg:flex-row dark:bg-black dark:text-white'>
                <div className="about-section flex flex-col items-center justify-center">
                    <h1 className='text-5xl p-10 font-bebas'>About Me</h1>
                    <div className='text-center w-full p-10 text-2xl flex flex-wrap justify-center gap-10 dark:bg-black dark:text-white dark:border-white'>
                ...
                <div className="availibility-section flex flex-col items-center justify-center">
                    <h1 className='text-5xl p-10 font-bebas'>Availability</h1>
                    <div className='text-center w-full p-10 text-2xl flex flex-wrap justify-center gap-10 dark:bg-black dark:text-white dark:border-white'>
